    ...
    <div style={{
      ...
      <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', padding: '0 24px', width: '100%', maxWidth: 480 }}>
        ...
        <div style={{
          ...
          border: `1px solid ${state === 'success' ? 'rgba(5,150,105,0.25)' : state === 'error' ? 'rgba(239,68,68,0.25)' : 'rgba(255,255,255,0.08)'}`,
          ...
          {state === 'loading' && (
            <>
              ...
              <p style={{ color: '#9ca3af', fontSize: 15, margin: 0 }}>Sipariş onaylanıyor...</p>
            </>
          )}
            ...
            <>
              ...
              {order && (
                <p style={{ color: '#6b7280', fontSize: 14, margin: '0 0 8px' }}>
                  Merhaba {order.customerName}, {order.total.toFixed(2)} ₺ tutarındaki siparişiniz başarıyla onaylandı.
                </p>
              )}
              <p style={{ color: '#4b5563', fontSize: 13, margin: '0 0 32px' }}>
                Siparişiniz en kısa sürede hazırlanacak, teşekkür ederiz.
              </p>
              <div style={{
