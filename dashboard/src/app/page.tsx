...
const faqs = [
  { q: 'Checkify nasıl çalışır?', a: 'Shopify mağazanıza webhook bağlantısı kurarsınız. Yeni kapıda ödeme siparişi geldiğinde müşterinize otomatik SMS gönderilir. Müşteri onaylarsa sipariş işleme alınır, reddederse iptal edilir.' },
  { q: 'Hangi kargo firmalarıyla uyumlu?', a: 'Checkify kargo firmasından bağımsız çalışır. Shopify üzerindeki tüm siparişler için çalışır.' },
...
const steps = [
  { num: '01', title: 'Mağazanı bağla', desc: 'Shopify mağazanı Checkify\'a bağla. Webhook kurulumu tek tık.' },
  { num: '02', title: 'Sipariş gelir', desc: 'Kapıda ödeme siparişi alındığında Checkify otomatik devreye girer.' },
